    ...
    >
      ...
      >
        ...
        <div className="relative h-48 md:h-52 overflow-hidden">
          ...
          <div className="absolute top-4 left-4 z-10">
            <span className={cn(
              ...
              "shadow-[0_4px_12px_rgba(18,164,237,0.4)]"
            )}>
              {post.category}
            </span>
          </div>
          ...
          {post.featured && (
            <div className="absolute top-4 right-4 z-10">
              <span className={cn(
                ...
                "bg-yellow-500/90 text-black backdrop-blur-sm",
        ...
        <div className="relative p-6 flex flex-col flex-grow z-[2]">
          ...
          {/* Title */}
          <h3 className={cn(
            "text-heading-sm font-heading text-white mb-3",
          ...
          {/* Excerpt */}
          <p className={cn(
            "text-body-sm text-white/80 leading-relaxed mb-6 flex-grow",
        ...
        <div className={cn(
          ...
          "bg-gradient-to-tl from-primary/[0.04] to-transparent",
        ...
        >
          ...
          <div className="text-center space-y-6 max-w-4xl mx-auto relative">
            ...
            <div className="relative z-10 py-8">
              ...
              >
                ...
                our project showcases, and industry insights.
              </motion.p>
            </div>
          </div>
          ...
          >
            <Link
              href="/blog"
              className={cn(
                "inline-flex items-center space-x-2 px-8 py-4 rounded-2xl",
                "bg-white/[0.04] backdrop-blur-xl border border-white/[0.08]",
                "text-white font-medium",
                "hover:bg-white/[0.08] hover:border-white/[0.12]",
                "hover:shadow-[0_8px_32px_rgba(18,164,237,0.2)]",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Blog",
            "name": "KDVLAB Blog",
            "description": "Latest news and insights about software development, web applications, and technology trends",
